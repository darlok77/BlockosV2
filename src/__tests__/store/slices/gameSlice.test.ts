...
describe("gameSlice", () => {
	describe("setDiceResult", () => {
		...
		it("should not set dice result if already set", () => {
			...
			const stateWithDice = game.given(
		...
		it("should not set dice result if dice used already set", () => {
			...
			const stateWithDiceUsed = game.given(
	...
	describe("selectSequence", () => {
		...
		it("should select sequence and reset counters", () => {
			...
			const stateWithSequences = game.given(
				"dice used values {array} with sequences",
				[1, 2],
				sequences,
				state,
			);
			const stateWithBlocks = game.given(
				"blocks placed count is {number}",
				2,
				stateWithSequences,
			);
			const stateWithPosition = game.given(
	...
	describe("completeSequence", () => {
		...
		it("should complete sequence and move to next", () => {
			...
			const stateWithSelected = game.given(
		...
		it("should clear playable positions when all sequences completed", () => {
			...
			const sequences: BlockToPlace[] = [{ type: "attack", nbBlocks: 1 }];
			const stateWithSequences = game.given(
				"dice used values {array} with sequences",
				[1],
				sequences,
	...
	describe("playablePositions", () => {
		...
		it("should recalculate playable positions", () => {
			...
			const sequences: BlockToPlace[] = [{ type: "defense", nbBlocks: 1 }];
			state = game.given(
				"dice used values {array} with sequences",
				[2],
				sequences,
